...
<div class="bg-gray-500 text-white py-2">
        <div class="container mx-auto flex justify-between items-center">
            <p class="text-sm">
                <span>Phone no:</span> <a href="tel:+001234567">+63 902-0654-7090</a> &nbsp;&nbsp; |&nbsp; &nbsp;
                <span>Email:</span> <a href="mailto:emailsample@email.com">ds.it.solutions.2024@gmail.com</a>
            </p>
            <div class="flex space-x-2">
                <a href="https://www.facebook.com/p/ds-it-solution-61564977374023/" class="text-white">
                <svg fill="#000000" class="h-4 w-4" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                ...
                <a href="https://www.facebook.com/messages/t/399505886584985" class="text-white">
                <svg class="h-4 w-4" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none">
  ...
  <nav class="bg-transparent fixed w-full z-10 text-white transition duration-300" id="navbar">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-6 bg-transparent">
      ...
      <a href="#" class="flex items-center space-x-3">
        <img src="{{ asset('images/DeadlyS.webp') }}" class="h-8" alt="DS IT SOLUTION Logo" />
        <span class="self-center text-2xl font-semibold tracking-wide">DS IT SOLUTIONS</span>
      </a>
      
      <!-- Hamburger Menu Button for Mobile -->
      <div class="flex md:order-2">
        <button data-collapse-toggle="navbar-cta" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg md:hidden focus:outline-none focus:ring-2 focus:ring-white" aria-controls="navbar-cta" aria-expanded="false">
